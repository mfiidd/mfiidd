...
We use the Gillespie algorithm introduced in the [Structure and stochasticity](seitl.qmd) session, adapted here for the SEIT4L model with its four T compartments.
