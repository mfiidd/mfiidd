...
Substituting `BF(n_particles; threshold = 0.5, resampler = Multinomial())` for `BF(n_particles)` in the runner turns that argument into something you can measure with the calibration cell.
