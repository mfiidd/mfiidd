...
We use the Gillespie algorithm introduced in the [SEITL session](seitl.qmd), with `k = 4` for the four T compartments:

```{julia}
seitl_stoichiometry(4)
```
...
- **Transitions**: The pairs above, as `(from, to)` compartment indices
