...
## Four choices behind one inference {.smaller}
...
## When things do not work {.smaller}

**Slow, sticky, or divergent** is often the sampler, and often fixable: retune
the proposal, reparameterise the funnel, raise the particle count until the
variance of the log-likelihood estimate is around one.

**Biased, overconfident, or simply wrong** is rarely the sampler.
...
## Questions to ask of your own model

- Is the process stochastic in a way that matters at your population size?
- Can you evaluate the likelihood? Can you differentiate it?
- How expensive is one simulation, and how many can you afford?
- Which features of the data would an approximate method discard?
- What would tell you the fit had failed, and would it be loud or silent?

## {{< fa laptop-code >}} Your Turn {background-color="#447099" transition="fade-in"}

Now take a model *you* actually want to fit. You have **two minutes**.

Work through the five questions on the previous slide. This should help answer
these two questions:

- Which inference method would you use?
...
- @funk2020 sets out the four choices and four criteria, with worked
  examples in pomp and rbi (becoming outdated).
- @fasiolo2016 compare the method families on nonlinear state space models in
  ecology and epidemiology.
- @li2018 compare MCMC approaches for mechanistic epidemic models, staying inside
  the case where the likelihood is tractable.
...
- [Nowcasting and forecasting infectious disease
  dynamics](https://nfidd.github.io/nfidd/) picks up where we stopped: reporting
  delays, right truncation and evidence synthesis.

## Before you go {.smaller}

- A short **feedback survey** is coming by email and linked on the course
  website. This is the first time we have taught the material in this form, so
  please fill it in.
