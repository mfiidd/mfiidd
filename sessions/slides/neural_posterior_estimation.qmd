...
`R_0` is the exception, and it is the interesting one: its width matches PMMH
almost exactly, while its centre sits about a posterior standard deviation low.

. . .

Wider is the direction the theory predicts, and the safer way to be wrong.
...
- see calibration and the width comparison land on the same parameter, and disagree about it
