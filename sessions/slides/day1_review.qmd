...
We want means, quantiles, forecasts, scenarios, and a mechanistic model gives us
none of them in closed form. Draws $\theta_1, \theta_2, \ldots$ from
$p(\theta \mid \text{data})$ give all of them: average them, take their
quantiles, or run the model once for each draw.
