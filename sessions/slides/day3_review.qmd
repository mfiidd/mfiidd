...
## Posteriors for a stochastic model

![](images/pmmh_posteriors.svg)

## And the trajectories that go with them

![](images/pmmh_filtered_vs_resimulated.svg)

::: {.cite}
Re-simulated paths never see the data; filtered paths are conditioned on it.
:::
