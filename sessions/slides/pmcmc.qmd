...
![](images/pf_3_weight.png){.mini}

The filter gives an estimate of the marginal likelihood at **one** value of
$\theta$:
...
We want the **posterior** over $\theta$.
...
[The structure of the model chooses the criterion.]{.alert}
...
- fit SEIT4L as well, and separate the two with DIC and a predictive check
