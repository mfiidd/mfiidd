...
::: {.fragment}
Rule of thumb: $\hat{R} < 1.01$. Above 1.1 is a red flag.
:::
...
MCMC samples are correlated, so $N$ of them are worth fewer than $N$ independent
draws. [ESS]{.alert} estimates how many you actually have.
...
noise: a different seed changes it. Sample until the MCSE is small next to the
precision you want to claim.

::: {.fragment}
Bulk ESS describes the centre of the distribution, tail ESS the extremes, which
is what credible interval endpoints depend on.
:::
